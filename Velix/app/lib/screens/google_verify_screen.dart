...
/// Shown to new Google-sign-in users who still need rules agreement + ID
/// verification. Existing Google users skip this screen entirely.
class GoogleVerifyScreen extends ConsumerStatefulWidget {
  const GoogleVerifyScreen({super.key});

  @override
  ConsumerState<GoogleVerifyScreen> createState() =>
      _GoogleVerifyScreenState();
}

class _GoogleVerifyScreenState extends ConsumerState<GoogleVerifyScreen> {
  ...
  static const _stepTitles = ['閱讀規範', '身份驗證'];
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                _PolicySection(title: '隱私權政策', content: kPrivacyPolicyText),
                const SizedBox(height: 16),
                _PolicySection(title: '社群準則', content: kCommunityGuidelinesText),
                const SizedBox(height: 16),
                _PolicySection(title: '免責聲明', content: kDisclaimerText),
            ...
            children: [
              ...
              CheckboxListTile(
                ...
                onChanged: _reachedBottom
                    ...
                    : null,
                title: const Text('我已閱讀並同意所有規範與政策',
      ...
      child: Column(
        ...
        children: [
          ...
          _UploadTile(
            ...
            label: '點擊拍攝自拍照',
            onTap: () async {
              final file = await ref.read(storageServiceProvider).captureSelfie();
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () async {
                ...
                final file =
                    await ref.read(storageServiceProvider).captureIdCard();
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: file != null ? AppTheme.accent : AppTheme.divider,
            width: file != null ? 2 : 1,
          ),
        ),
        child: file != null
