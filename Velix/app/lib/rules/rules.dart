    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: const TabBarView(
          children: [
            _PolicyTab(content: _privacyPolicy),
            // _PolicyTab(content: _termsOfService),
            _PolicyTab(content: _communityGuidelines),
            _PolicyTab(content: _rules),
          ],
        ),
      ),
    );
...
// ── Public exports（供 register_screen 等其他檔案 import）──────
const kPrivacyPolicyText = _privacyPolicy;
const kCommunityGuidelinesText = _communityGuidelines;
const kDisclaimerText = _rules;
