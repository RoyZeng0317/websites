/* ─── Game Engine — client side port of game_engine.py ─── */
...
class GameState {
  ...
  update(keys) {
    ...
    for (const m of this.monsters) {
      ...
      m.targetX = this.player.x; m.targetY = this.player.y;
  ...
  _spawnMonster() {
    ...
    this.monsters.push(new Monster(x, y, this.player.x, this.player.y));
  }
