...
const LINKS = [
  {
    ...
    sub: 'visualstudio.microsoft.com — 官網 / 下載',
    url: 'https://visualstudio.microsoft.com/zh-hant/',
    primary: true,
  },
  {
    label: 'Visual Studio Live Share',
    sub: 'liveshare.visualstudio.com — 即時協作，無需完整安裝',
    url: 'https://visualstudio.microsoft.com/zh-hant/services/live-share/',
    primary: false,
  },
  {
    label: 'My Visual Studio（授權管理）',
    sub: 'my.visualstudio.com — 訂閱、金鑰、授權',
    url: 'https://my.visualstudio.com',
    primary: false,
  },
  {
    label: 'Visual Studio Marketplace',
    sub: 'marketplace.visualstudio.com — 擴充功能',
      ...
      <div className="bg-gray-900 border border-gray-700 rounded-2xl shadow-2xl w-full max-w-md mx-4"
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-500 text-xs">開啟於新分頁</p>
            </div>
          </div>
        ...
        <div className="mx-4 mt-4 px-3 py-2.5 rounded-lg bg-purple-950/30 border border-purple-900/40 flex items-start gap-2">
          ...
          <p className="text-xs text-purple-300 leading-relaxed">
            Visual Studio 為 Windows 桌面應用程式，無法嵌入網頁。點擊下方連結於新分頁開啟，或從桌面直接啟動。
          </p>
        </div>
        ...
        <div className="px-5 pb-4">
          <p className="text-xs text-gray-600 text-center">
            若需從其他裝置遠端使用，可透過 Windows 遠端桌面（RDP）存取
          </p>
        </div>
      </div>
    </div>
