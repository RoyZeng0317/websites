...
const _raw: Record<string, { name: string; market: string }> = {
  ...
  "5274.TW": { name: "信驊", market: "TW" },
  "5347.TW": { name: "世界先進", market: "TW" },
  ...
  "8069.TW": { name: "元太", market: "TW" },
  "8110.TW": { name: "華東", market: "TW" },
  "9105.TW": { name: "泰金寶", market: "TW" },
  "1268.TW": { name: "漢來美食", market: "TW" },
  ...
  "006201.TW": { name: "元大上證50", market: "TW" },
  ...
  "00888.TW": { name: "永豐台灣ESG", market: "TW" },
  ...
  "00886.TW": { name: "永豐美國科技", market: "TW" },
  "00889.TW": { name: "富邦台灣半導體", market: "TW" },
  ...
  "00858.TW": { name: "永豐美國500大", market: "TW" },
  ...
  "009806.TW": { name: "元大全球半導體", market: "TW" },
  "009807.TW": { name: "統一ESG投等債", market: "TW" },
  ...
  "009815.TW": { name: "元大全球公用能源", market: "TW" },
  ...
  "009822.TW": { name: "凱基全球永續", market: "TW" },
  "009823.TW": { name: "復華台灣科技高息", market: "TW" },
...
export function searchLocal(query: string): StockSearchResult[] {
  ...
  for (const s of localStockIndex) {
    ...
    const bareCode = symLower.replace(/\.(tw|twо|hk)$/i, '')
